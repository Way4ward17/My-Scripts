...
$Sqlresultt = "SELECT * FROM Post WHERE LOWER(details) LIKE LOWER('%$details%') OR LOWER(details) LIKE LOWER('$details%') OR LOWER(details) LIKE LOWER('%$details') LIMIT $count_per_page OFFSET $next_offset"; 
