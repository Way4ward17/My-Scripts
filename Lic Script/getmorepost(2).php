...
$sql = "SELECT Followee FROM `Follow` WHERE Followerid = '$userid'";
...
$Sqlresultt = "SELECT * FROM Post WHERE userid = '$Followee' ORDER BY id DESC LIMIT $count_per_page OFFSET $next_offset"; 
